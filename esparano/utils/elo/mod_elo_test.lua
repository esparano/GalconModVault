...
function test_available_functions()
    assert.not_equals(nil, elo)
    assert.not_equals(nil, elo.update_elo)
    assert.not_equals(nil, elo.get_elo)
    assert.not_equals(nil, elo.set_elo)
    assert.not_equals(nil, elo.get_default_elo)
    assert.not_equals(nil, elo.set_default_elo)
    assert.not_equals(nil, elo.get_k)
    assert.not_equals(nil, elo.set_k)
    assert.not_equals(nil, elo.print_ratings)
    assert.not_equals(nil, elo.save_ratings)
    assert.not_equals(nil, elo.load_ratings)
    assert.not_equals(nil, elo.clear_ratings)
    assert.not_equals(nil, elo._win_probability)
    assert.not_equals(nil, elo._calculate_new_elos)
end

function test_local_functions()
    assert.equals(nil, update_elo)
    assert.equals(nil, get_elo)
    assert.equals(nil, set_elo)
    assert.equals(nil, get_default_elo)
    assert.equals(nil, set_default_elo)
    assert.equals(nil, get_k)
    assert.equals(nil, set_k)
    assert.equals(nil, print_ratings)
    assert.equals(nil, save_ratings)
    assert.equals(nil, load_ratings)
    assert.equals(nil, clear_ratings)
    assert.equals(nil, _win_probability)
    assert.equals(nil, _calculate_new_elos) 
end
