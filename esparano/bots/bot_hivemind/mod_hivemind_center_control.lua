...
function _m_init()
    ...
    function CenterControlMind:suggestActions(map, mapTunnels, mapFuture, botUser)
        return {}
    end

    function CenterControlMind:gradeAction(map, mapTunnels, mapFuture, botUser, action)
