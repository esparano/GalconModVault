                ...
                if p.owner_n == user.n then
                    ...
                    if p.ships_value + p.total_incoming_fleets > amount_left then -- there are enough "stored" ships in this planet to capture
                        if p.ships_value < amount_left then
                            ...
                            p.total_incoming_fleets = math.max(p.total_incoming_fleets - (amount_left - p.ships_value), 0) -- use up some fleets
                        else 
                        ...
                        if (ships_sent > 0) then print("n: "..p.n..", target: " .. target.n .. ", alias:" .. tunnel_alias.n) end
