...
function client_init()
    ...
    function obj:event(e)
        ...
        if (e.type == "onclick" or e.type == "onchange") and e.value ~= nil and e.value:sub(1,1) == "/" then
            ...
            g2.state = GAME.state
			GAME.modules.clients:event({uid=g2.uid,name=g2.name,type='net:message',value=e.value})
        end
        if (e.type == "onclick" or e.type == "onchange") and e.value ~= nil and e.value:sub(1,1) == "*" then
			...
			GAME.modules.clients:event({uid=g2.uid,name=g2.name,type='net:'..cmd,value=values})
        end
